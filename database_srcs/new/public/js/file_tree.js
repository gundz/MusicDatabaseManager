...
function getInfos(node)
{
	...
	if (typeof bitrate === 'undefined')
		...
		var bitrate_text = '<div class="bitrate_info">' +bitrate+ '</div>';


	if (typeof node._country === 'undefined')
		var country = "";
	else
		var country = formatCountry2(node._country);
	...
	if (node._type == "dir")
	{
		retText += '<div class="country_info"><a id="country" data-type="select2">' +country+ '</a></div>';
	}
